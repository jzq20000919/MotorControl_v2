...
/* Private defines -----------------------------------------------------------*/
#define M1_DP_Pin GPIO_PIN_13
#define M1_DP_GPIO_Port GPIOC
#define M1_CURR_AMPL_U_Pin GPIO_PIN_3
#define M1_CURR_AMPL_U_GPIO_Port GPIOC
#define M1_SHUNT_P_U_Pin GPIO_PIN_1
#define M1_SHUNT_P_U_GPIO_Port GPIOA
#define M1_CURR_AMP_U_Pin GPIO_PIN_2
#define M1_CURR_AMP_U_GPIO_Port GPIOA
#define M1_SHUNT_M_U_Pin GPIO_PIN_3
#define M1_SHUNT_M_U_GPIO_Port GPIOA
#define DBG_DAC_CH1_Pin GPIO_PIN_4
#define DBG_DAC_CH1_GPIO_Port GPIOA
#define M1_SHUNT_M_V_Pin GPIO_PIN_5
#define M1_SHUNT_M_V_GPIO_Port GPIOA
#define M1_CURR_AMP_V_Pin GPIO_PIN_6
#define M1_CURR_AMP_V_GPIO_Port GPIOA
#define M1_SHUNT_P_V_Pin GPIO_PIN_7
#define M1_SHUNT_P_V_GPIO_Port GPIOA
#define M1_CURR_AMPL_V_Pin GPIO_PIN_4
#define M1_CURR_AMPL_V_GPIO_Port GPIOC
#define M1_SHUNT_P_W_Pin GPIO_PIN_0
#define M1_SHUNT_P_W_GPIO_Port GPIOB
#define M1_CURR_AMP_W_Pin GPIO_PIN_1
#define M1_CURR_AMP_W_GPIO_Port GPIOB
#define M1_SHUNT_M_W_Pin GPIO_PIN_2
#define M1_SHUNT_M_W_GPIO_Port GPIOB
...
#define M1_CURR_AMPL_W_Pin GPIO_PIN_14
