...
PID_Handle_t PID_PosParamsM1 =
{
  ...
  .wUpperIntegralLimit = (int32_t)(POSITION_MAX_CURRENT_A * CURRENT_CONV_FACTOR * PID_POSITION_KIDIV),
  .wLowerIntegralLimit = (int32_t)(-POSITION_MAX_CURRENT_A * CURRENT_CONV_FACTOR * PID_POSITION_KIDIV),
  .hUpperOutputLimit   = (int16_t)(POSITION_MAX_CURRENT_A * CURRENT_CONV_FACTOR),
  .hLowerOutputLimit   = -(int16_t)(POSITION_MAX_CURRENT_A * CURRENT_CONV_FACTOR),
